    ...
    <header className="bg-white w-full border-b border-[#D9D4CC] relative z-50">
      ...
      <div className="border-b border-[#D9D4CC] hidden md:block">
        <div className="max-w-[1200px] mx-auto px-5 py-2 flex items-center justify-end gap-6">
          ...
          <a href="tel:+33480161783" className="bg-[#BA7517] text-white text-[13px] font-bold px-3 py-1 rounded flex flex-col items-center leading-tight no-underline hover:bg-[#9E6312] transition-colors">
            <span>04 80 16 17 83</span>
