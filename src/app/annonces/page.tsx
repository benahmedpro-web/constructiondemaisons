...
export const metadata: Metadata = {
  ...
  description: "Terrains à bâtir et projets maison ossature bois à saisir en Haute-Savoie et Grand Genève. Sélection de notre partenaire foncier.",
  alternates: {
    canonical: "https://www.constructiondemaisons.com/annonces/",
  },
  openGraph: {
    title: "Terrains & projets disponibles en Haute-Savoie",
    description: "Terrains à bâtir et projets maison ossature bois à saisir en Haute-Savoie et Grand Genève.",
