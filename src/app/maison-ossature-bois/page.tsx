          ...
          <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-10 items-start">
            <div>
              ...
              <p className="text-[16px] text-[#888780] leading-[1.8]">
                En zone sismique 3 — qui couvre Annemasse, Saint-Julien-en-Genevois, Annecy et une grande partie de la Haute-Savoie — les règles parasismiques imposent des contreventements spécifiques à l&apos;ossature bois. Le bureau d&apos;études structure que nous mandatons maîtrise ces contraintes. La réglementation RE2020, en vigueur depuis janvier 2022, favorise les matériaux biosourcés : une maison bois neuve respecte ces exigences nativement, sans surcoût de mise en conformité. Budget indicatif sur notre zone : <strong className="text-[#2C2C2A]">1 700 à 2 800 € HT/m²</strong> en maîtrise d&apos;œuvre, finitions comprises, hors terrain.
              </p>
            </div>
