...
const jsonLdBusiness = {
  ...
  description:
    "Maîtrise d'œuvre spécialisée construction maison ossature bois en Haute-Savoie, Genevois français, Ain et Grand Genève. Conception, permis de construire, coordination de chantier.",
...
const jsonLdWebsite = {
  ...
  name: "M&M CONSTRUCTION",
  description:
    "Maîtrise d'œuvre maison ossature bois en Haute-Savoie, Genevois français et Grand Genève.",
...
export const metadata: Metadata = {
  ...
  description:
    "Maîtrise d'œuvre maison ossature bois en Haute-Savoie, Genevois français et Grand Genève. 20 ans d'expérience, artisans vérifiés. Étude gratuite.",
  ...
  twitter: {
    ...
    title: "M&M CONSTRUCTION — Maison ossature bois Haute-Savoie",
    description:
      "Maîtrise d'œuvre maison ossature bois en Haute-Savoie, Genevois français et Grand Genève. 20 ans d'expérience, artisans vérifiés.",
